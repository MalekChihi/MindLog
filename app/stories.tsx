...
export default function StoriesScreen() {
  ...
  const savedStories = [
    { id: '1', date: '2023-06-15', title: 'A Difficult Work Day', preview: 'I had a challenging meeting with my boss...' },
    { id: '2', date: '2023-06-10', title: 'Argument With Friend', preview: 'My friend and I disagreed about...' },
  ];
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.topBar}>
        <Pressable onPress={() => navigation.navigate('(tabs)')} style={styles.backButton}>
          <Ionicons name="arrow-back" size={24} color="#1e293b" />
          <Text style={styles.backText}>Back</Text>
        </Pressable>

        <Pressable onPress={() => navigation.navigate('storieshistory')} style={styles.historyButton}>
      ...
      <Text style={styles.description}>
        Write about a challenging experience, and our AI will help you discover a more hopeful perspective.
      </Text>
      ...
      {/* ✅ Conditionally show saved stories */}
